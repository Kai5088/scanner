...
bool Scanner::outputFile(const char fn[]){
	...
	if(countTokenClass(13) > 0)
    {
        FILEOUT<<"\n\nUndefined token: "<<countTokenClass(13)<<"\n";
        for(auto &i: token[13].word){
            num = i.second;
            if(num > 0){
                FILEOUT<<i.first<<"\t";
                if(num > 1)
	...
	if(countTokenClass(14) > 0)
    {
        FILEOUT<<"\n\nSkipped token: "<<countTokenClass(14)<<"\n";
        for(auto &i: token[14].word){
            num = i.second;
            if(num > 0){
                FILEOUT<<i.first<<"\t";
                if(num > 1)
    ...
    if(countTokenClass(15) > 0)
    {
        FILEOUT<<"\n\nCharacter: "<<countTokenClass(15)<<"\n";
        for(auto &i: token[15].word){
            num = i.second;
            if(num > 0){
                FILEOUT<<i.first<<"\t";
                if(num > 1)
...
void Scanner::initToken(){
    ...
    token[13].tokenClass = UndefinedToken;   
    token[14].tokenClass = SkippedToken;   
    token[15].tokenClass = Character;   
}
        ...
        while(!foundToken ){ // && (n_char<=t_char-1 && n_line<t_line-1)
            ...
            switch(state){
                if(varLine != n_line)
                        foundType = false;
                case 0:
                    if(isLetter(c) && !foundPrintf && !foundScanf) state = 1;
                ...
                case 1:
                    ...
                    cout<<"foundType:"<< foundType<<"\n";
                    cout<<"n_line:"<< n_line<<"\n";
                    if((isLetter(c) || isDigit(c) || c == '_'||c=='.') && STOP < 1){
                        buff.push_back(c);
                        //log
                        ...
                        while(regex_match(buff,m,RW_include)){
                            for(auto &match : m){
                                //sm = match;
                                pos = m.position();
                                token[0].word["include"]++;
                                
                                str_arr.emplace_back("token "+buff+" belongs to ReservedWord");
                        ...
                        while(regex_match(buff,m,RW_printf)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["printf"]++;
                        ...
                        while(regex_match(buff,m,RW_scanf)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["scanf"]++;
                        ...
                        while(regex_match(buff,m,RW_main)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["main"]++;
                        ...
                        while(regex_match(buff,m,RW_char)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["char"]++;
                        ...
                        while(regex_match(buff,m,RW_int)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["int"]++;
                        ...
                        while(regex_match(buff,m,RW_float)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["float"]++;
                        ...
                        while(regex_match(buff,m,RW_elseif)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["elseif"]++;
                        ...
                        regex RW_if("[iI][fF]");
                        while(regex_match(buff,m,RW_if)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["if"]++;
                        ...
                        while(regex_match(buff,m,RW_else)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["else"]++;
                        ...
                        while(regex_match(buff,m,RW_for)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["for"]++;
                        ...
                        while(regex_match(buff,m,RW_while)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["while"]++;
                        ...
                        regex RW_do("[dD][oO]");
                        while(regex_match(buff,m,RW_do)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["do"]++;
                        ...
                        while(regex_match(buff,m,RW_return)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["return"]++;
                        ...
                        while(regex_match(buff,m,RW_switch)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["switch"]++;
                        ...
                        while(regex_match(buff,m,RW_case)){
                            for(auto &match : m){
                                pos = m.position();
                                token[0].word["case"]++;
                        ...
                        if(foundType){
                            ...
                            if(regex_match(buff,IDEN)){
                                ...
                                str_arr.emplace_back("token "+buff+" belongs to Identifier");
                            ...
                            if(regex_match(buff,AD)){
                                ...
                                str_arr.emplace_back("token "+buff+" belongs to Address");
                            ...
                            if(regex_match(buff,POINT)){
                                ...
                                str_arr.emplace_back("token "+buff+" belongs to Pointer");
                        ...
                        if(token[3].word[buff]>0){
							...
							str_arr.emplace_back("token "+buff+" belongs to Undefined token");
                            token[13].word[buff]++;
                            buff = "";
                            ...
                            cout<<"Skip token: "<<buff<<"\n";
                            str_arr.emplace_back("token "+buff+" belongs to skipped token");
                            token[14].word[buff]++;
                ...
                case 2:
                {
                    ...
                    if((isDigit(c)) && STOP < 1){
                        ...
                        str_arr.emplace_back("token "+buff+" belongs to Constant");
                ...
                case 3:
                {
                    ...
                    str_arr.emplace_back("token + belongs to Operator");
                ...
                case 5:
                {
                    ...
                    if(token[9].word[tempBuff] > 0){
                        ...
                        str_arr.emplace_back("token "+tempBuff+" belongs to Pointer");
                        foundToken = true;
                ...
                case 6:
                {
                    ...
                    if(tem == '/'){
                        ...
                        str_arr.emplace_back("token "+buff+" belongs to Comment");
                ...
                case 7:
                {
                    ...
                    if(tem == 'd' || tem == 'f' || tem == 'c')
                    {
                        ...
                        str_arr.emplace_back("token "+buff+" belongs to format specifier");
                ...
                case 11:
                {
                    ...
                    if(tem == '='){
                        ...
                        str_arr.emplace_back("token == belongs to Comparator");
                    ...
                    while(foundLibrary){
                        ...
                        if(c == '>'){
                            ...
                            if(regex_match(buff,LN)){
                                ...
                                str_arr.emplace_back("token "+buff+" belongs to LibraryName");
                ...
                case 15:
                {
                    ...
                    str_arr.emplace_back("token ( belongs to bracket");
                    varLine = n_line;
                    cout<<"( :"<<token[7].word["("]<<"\n";
                    STOP = moveChar();
                    buff = "";
                ...
                case 21:
                    ...
                    str_arr.emplace_back("token , belongs to punctuation");
                ...
                case 26:
                {
                    ...
                    tempBuff.pop_back();
                    token[15].word[tempBuff]++;
                    str_arr.emplace_back("token "+tempBuff+" belongs to Character");
                ...
                case 30:
                {
                    ...
                    if(foundPrintf){
                        ...
                        str_arr.emplace_back("token "+buff+" belongs to printed token");
